...
public class ProximityServiceImpl implements ProximityService{
    ...
    @Autowired
    public ProximityServiceImpl(IPSCMatchRepository matchRepository,
    ...
    @Override
    public void saveProximityData(IPSCMatch match, List<Airport> closestAirports) {
    ...
    @Override
    public Proximity createProximity(IPSCMatch match, Airport airport, double distance) {
    ...
    @Override
    public List<Airport> findTwoClosestAirports(IPSCMatch match) {
