...
@Service
@Slf4j
public class MatchScraperImpl implements MatchScraper {
    @Value("${ipsc.calendar.url}")
    private String IPSC_CALENDAR_URL;
    private final IPSCMatchRepository IPSCMatchRepository;
    private final MatchDetailsScraperImpl matchDetailsScraper;

    @Autowired
    public MatchScraperImpl(IPSCMatchRepository IPSCMatchRepository,
                            MatchDetailsScraperImpl matchDetailsScraper) {
