...
@Service
@Slf4j
public class AppendGeocodeServiceImpl implements AppendGeocodeService{
    ...
    @Autowired
    public AppendGeocodeServiceImpl(IPSCMatchRepository matchRepository, GeocodingServiceImpl geocodingService, SpatialService spatialServiceImpl) {
        this.matchRepository = matchRepository;
        this.geocodingService = geocodingService;
        this.spatialService = spatialServiceImpl;
    }
